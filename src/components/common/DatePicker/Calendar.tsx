...
import RiArrowLeftDoubleLine from '~icons/ri/arrow-left-double-line.jsx'
import RiArrowLeftSLine from '~icons/ri/arrow-left-s-line.jsx'
import RiArrowRightDoubleLine from '~icons/ri/arrow-right-double-line.jsx'
import RiArrowRightSLine from '~icons/ri/arrow-right-s-line.jsx'
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        row: 'w-full mt-0.5',
        cell: cn('relative p-0 text-center focus-within:relative', 'text-gray-900 dark:text-gray-50'),
        day: cn(
        ...
        day_selected: cn(
          'rounded',
          'aria-selected:bg-t-brand aria-selected:text-gray-50',
        ...
        day_range_middle: cn(
          '!rounded-none',
          'aria-selected:!bg-blue-50 aria-selected:!text-t-brand',
              ...
              {today && (
                <span
                  className={cn('absolute inset-x-1/2 bottom-1.5 h-0.5 w-4 -translate-x-1/2 rounded-[2px]', {
                    'bg-s-brand-primary dark:bg-s-brand-primary': !selected,
